      ...
      body: GetBuilder<AuthController>(builder: (authController) {
        return authController.profileModel == null
            ...
            : ProfileBgWidget(
                ...
                bankWidget: SingleChildScrollView(
                  child: Text('HI This IS it In '),
                ),
                      ...
                      child: Column(children: [
                        ...
                        Column(
                          children: [
                            SizedBox(width: Dimensions.PADDING_SIZE_SMALL),
                            Text(
                              'Holder Name:  ${authController.profileModel.holder_name}',
                              style: robotoMedium.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_LARGE),
                            ),
                            Text(
                              'Bank Name:  ${authController.profileModel.bank_name}',
                              style: robotoMedium.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_LARGE),
                            ),
                            Text(
                              'Branch Name:  ${authController.profileModel.branch_add}',
                              style: robotoMedium.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_LARGE),
                            ),
                            Text(
                              'Account No:  ${authController.profileModel.account_no}',
                              style: robotoMedium.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_LARGE),
                            ),
                            Text(
                              'IFSC Code:  ${authController.profileModel.ifsc_code}',
                              style: robotoMedium.copyWith(
                                  fontSize: Dimensions.FONT_SIZE_LARGE),
                            ),
                          ],
